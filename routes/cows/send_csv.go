...
// @Description  по ключу "LST" - путь к файлу csv в директории ./static/csv/
// @Tags         Cows
...
// @Router       /cows/filterCSV [post]
func (c *Cows) SendCSV() func(*gin.Context) {
	return func(c *gin.Context) {
		...
		file := filePath[len(PathToCSVFile):] // Возврат пути файл в директории ./static/excel/
