...
import (
	...
	"genmilk_backend/routes/admin"
	"genmilk_backend/routes/analitics"
	"genmilk_backend/routes/auth"
	"genmilk_backend/routes/breeds"
	checkmilks "genmilk_backend/routes/check_milks"
	"genmilk_backend/routes/cows"
	dailymilks "genmilk_backend/routes/daily_milks"
	"genmilk_backend/routes/districts"
	"genmilk_backend/routes/farms"
	"genmilk_backend/routes/gui"
	"genmilk_backend/routes/lactations"
	"genmilk_backend/routes/load"
	"genmilk_backend/routes/monogenetic_illnesses"
	"genmilk_backend/routes/partners"
	"genmilk_backend/routes/regions"
	"genmilk_backend/routes/sexes"
	"genmilk_backend/routes/updates"
	user_create "genmilk_backend/routes/user"
	"text/template"

	// "net/http"
	_ "genmilk_backend/docs"
